...
var Display = function(myDisplay){

  myDisplay.resize = function(width, height){
    $('#game_screen').attr('width', width).attr('height', height);
  };

  myDisplay.getDimensions = function(res){
    var dimens = [];
    switch(res){
      case '360p':
        dimens = [640 ,360];
  ...
  myDisplay.requestFullScreen = function() {
    // Supports most browsers and their versions.
    var element = document.getElementById('game_screen');
  ...
  myDisplay.requestWindowed = function() {
    var element = document.getElementById('game_screen');
    var requestMethod = document.exitFullscreen || document.msExitFullscreen || document.mozCancelFullScreen || document.webkitExitFullscreen;
