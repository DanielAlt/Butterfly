...
var EventText = function(myEventText){

	myEventText.spawn = function(evt_text, delta_max=9000){
		this.text = evt_text;
		...
		this.render = function(screen){
			if (this.visible){
				screen.fillStyle = "rgba(125,0,255,"+this.opacity+")";
