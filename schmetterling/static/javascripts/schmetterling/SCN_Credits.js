...
var CreditsScene = function(myCredits){

  myCredits.spawn = function(globalPersistence){
    var scroll_pos = globalPersistence.args['screen_size'][1];
    var _credits = [
      "Programmer.....................................Daniel Altenburg",
      "Artistic Director.....................................Natalie B.",
      " ",
      "Music",
      " ",
    ...
    var ambient_sound = new Sound.spawnAmbient(
      'static/audio/level_1/lasting_hope.mp3',
    ...
    this.render = function(screen){
      ...
      screen.font = '20px lunaregular';
      if (bg_img.loaded){
        bg_img.render(screen);
        var ypos = 0;
        for (var i=0; i < _credits.length; i++){
          screen.fillText(_credits[i], 35, scroll_pos+ypos);
          ypos += 25;
        };
      } else {
        bg_img.fillText('Loading', 35, scroll_pos);
      }
    };
  };
